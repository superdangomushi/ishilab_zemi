...
録音/記録/予定/秘書の4タブ・AI秘書チャット・Google カレンダー連携・Moodle/Waseda 連携・
...
3. 「秘書」タブの AIHelper.jp 連携でサーバーURL・アカウントを入力しログイン
...
| 画面（4タブ＋秘書チャット） | `Transcriber/App/ContentView.swift`, `Transcriber/UI/*.swift` |

# ishilab_zemi — 常時録音から動く「あなた専属の秘書」アプリ

研究室のゼミ課題(みんな見てね！！)

スマホのマイクで**常時録音**し、端末上で文字起こし → サーバーへ**定期アップロード** →
Gemini が**課題・予定を抽出**し、締切の **1日前・1時間前に通知＆LINEで警告**します。
さらに **その日1日の要約** を日付ごとにまとめ、チャットで聞けば
「今日の予定は？」に答え、「予定入れといて」と頼めば**登録まで**やってくれます。

> 宿題忘れ・予定忘れを「言われる前に思い出させてくれる秘書」を目指したアプリです。
